define(function() {
    return {
        ...
        'MYORDER_HAVE_DISCOUNT_CODE_OR_REWARDS': "Есть %s %s?",
        ...
        'PROMOTION_MULTIPLE_USE': 'Многоразовый',
        'PROMOTION_SINGLE_USE': 'Одноразовый',
        'PROMOTIONS': 'Купоны',
        'PROMOTIONS_ALL': 'Посмотреть все купоны магазина',
        'PROMOTIONS_AVAILABLE': 'Доступные купоны',
        'PROMOTIONS_AVAILABLE_DESC': 'Выбранные купоны будут применены к вашему следующему заказу',
        'PROMOTIONS_AVAILABLE_NO': 'К вашему заказу не может быть применен ни один купон.',
        'PROMOTIONS_OTHER': 'Другие купоны',
        'PROMOTION_DISCOUNT_CODE': 'Код на скидку',
